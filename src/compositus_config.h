...
#ifndef _COMPOSITUS_CONFIG_H_
#define _COMPOSITUS_CONFIG_H_

char *rec_session_db;

/* Default log path set in src/compositus.c */
extern char *log_dir;
...
/* Default debug level set in src/compositus.c */
